...
import numpy as np
__all__ = [
    "ConditionalBSplineTransformer",
]

DEFAULT_MIN_BIN_WIDTH = 1e-6 # 1e-4
DEFAULT_MIN_BIN_HEIGHT = 1e-6 # 1e-4

class ConditionalBSplineTransformer(Transformer):
    def __init__(
        self,
